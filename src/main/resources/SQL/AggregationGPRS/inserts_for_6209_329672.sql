-- offline: платные, изменяется несколько балансов в транзакции
declare
ctn varchar2(100);
iterator number;
...
executeOsaHistory:='Insert into OSA_HISTORY_'||tablePrefixDwh||'
 ...
 Values
   ...
   23, ''GPRS_BEELINE_VOLGA'', ''[1~'||core_balance||'~10~0][2~0.0000~0.0000~0][3~'||sms_balance||'~1.0000~0]'', 12345, 1,
   0, -1)';
iterator:=iterator+1;
