-- offline: платные, пополнение во время транзакции
declare
ctn varchar2(100);
iterator number;
...
executeRechargeHistory:='Insert into RECHARGE_HISTORY_'||tablePrefixDwh||'
 ...
 Values
   ('||ctn||', sysdate-2+('||(iterator+1)||'/(24*60)), ''non vouche'', 65, 0, 0, 0, 0, 12070368844, ''XPA,6039818932,1008,2,1111'', 279918750002, 6169982, 23, ''RUR'', 10, ''[1~'||core_balance||'~100~0]'', 1)';
