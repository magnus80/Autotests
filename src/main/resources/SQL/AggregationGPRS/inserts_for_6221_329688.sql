-- offline: бесплатные, ACTUAL_SERVICE_PARAMETER3 != NULL и ACTUAL_SERVICE_PARAMETER3 = Default, разные OSA_SUBTYPE
declare
ctn varchar2(100);
iterator number;
...
executeOsaHistory:='Insert into OSA_HISTORY_'||tablePrefixDwh||'
 ...
 Values
   ...
   1, ''SGSN_IP_ADDRESS:85.115.244.147'', ''''''Internet'''''', ''''''VOLUME_K'||iterator||''''''', 66,
   -1, -1, -1, -1, 2,
