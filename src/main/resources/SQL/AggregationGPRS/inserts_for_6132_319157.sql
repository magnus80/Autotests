...
loop
-- OSA_HISTORY, MERCHANT_ID = GPRS, ACTUAL_SERVICE_PARAMETER3 = CCBO_SETTING.DEFAULT_ACTUAL_SERVICE_PARAMETER3, объем услуг (трафик) USAGE_AMOUNT=0
...
executeOsaHistoryStmt:='Insert into OSA_HISTORY_MAIN_'||OsaHistoryTablePrefix_AB||'
 ...
 Values
   (0, '||subscr_no||', '||account_no||', NULL, NULL, 
    sysdate+('||iterator||'/24/60), sysdate+('||(iterator+1)||'/24/60), ''unitBasedCharge'', 0, NULL, 
