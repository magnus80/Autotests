...
executePsTransaction:='Insert into PS_TRANSACTION_'||tablePrefixDwh||'
 ...
 Values
   ('||ctn||', sysdate-2+'||iterator||'/(24*60), ''1'', 4, ''79281111360'', 2650382349, 2562273291, ''N'', 287515636049, 6234594, 23, ''RUR'', 0, ''RUR'', ''[1~'||start_core_balance||'~10~0]'', ''79624959999'', 203, sysdate-2+'||iterator||'/(24*60), 1, 1)';
