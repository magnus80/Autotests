...
executeCallHistory:='Insert into CALL_HISTORY_'||tablePrefixDwh||'
 ...
 Values
   ('||ctn||', sysdate-2+'||iterator||'/(24*60), ''79030000000'', 61, ''OUTGOING_OPPS_CALL'', 0, 16, 0, 0, ''79111123412'', 784048896812, 49030797, 23, ''79038889987'', ''250991770305226'', ''94'', ''RUR'', ''[1~'||start_core_balance||'~10~0]'', 108, 1)';
