...
executeCallHistory:='Insert into CALL_HISTORY_'||tablePrefixDwh||'
 ...
 Values
   ('||ctn||', sysdate-7+'||iterator||'/(24*60), ''79030372222'', 360, ''OUTGOING_OPPS_CALL'', 0, 16, 0, 0, ''79281111111'', 784048896812, 49030797, 28, ''79038889987'', ''250991770305226'', ''94'', ''RUR'', ''[1~100~10.0'||iterator||'~0]'', 108, 1)';
